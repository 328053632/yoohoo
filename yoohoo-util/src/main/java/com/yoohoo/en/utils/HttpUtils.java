...
import com.yoohoo.en.bean.talk.ParamsBean;
import com.yoohoo.en.bean.talk.RequestCallback;

public class HttpUtils {
	public static Object httpSend(String url, List<ParamsBean> params,
			RequestCallback<?> rcb) {
		String result=null;
		try {
	...
	public static String getValue(List<ParamsBean> params) {
		String value = "";
