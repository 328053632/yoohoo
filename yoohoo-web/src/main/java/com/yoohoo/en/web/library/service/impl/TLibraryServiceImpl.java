package com.yoohoo.en.web.library.service.impl;
...
public class TLibraryServiceImpl implements TLibraryService {
     ...
     */
    @Override
    public  List<Integer> saveMultipartFile(List<MultipartFile> file, String fileType, String userName) {
        ...
        for (MultipartFile mf:file){
            ...
            try {
                ...
                tLibrary.setCreateTime(new Date());
                tLibrary.setUplaodUser(userName);
                tLibraryMapper.insert(tLibrary);
