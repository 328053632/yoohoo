        ...
        <div v-if="hasData">
            ...
            <%--<div class="zlesson-info" v-for="(lesson,index) in lessonList" v-if="lesson.chapterList && lesson.chapterList.length > 0">--%>
                ...
                <%--<div v-if="null != lesson.chapterList" class="chapter-list">--%>
                    <%--<div v-for="chapter in lesson.chapterList" class="chapter" :id="chapter.chapterId" @click="showMenu(lesson, chapter, $event)">--%>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            query: function(pageNo) {
                ...
                var me = this;
                AjaxClient.post({
                    url: contextPath + '/stu/user/queryLessonList',
                    data: {
